<div class="sidebar clear" style="background-color: lightgreen;">
	<div class="samesidebar clear">
		<h2 style="background-color: green;">Categories</h2>
		<ul>
			<?php
	...
	<div class="samesidebar clear">
		<h2 style="background-color: green;">Latest articles</h2>
		<?php
