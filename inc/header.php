...
<body>
	<div class="headersection templete clear" style="background-color: green;">
		<a href="index.php">
			<div class="logo">
				<?php
		...
		<div class="social clear">
			...
			<div class="searchbtn clear">
				<form action="search.php" method="get">
					<input type="text" name="search" placeholder="Search keyword..." style="background-color: lightgreen;"/>
					<input type="submit" name="submit" value="Search" style="background-color: #339E0B;"/>
				</form>
			</div>
		</div>
	</div>
	<div class="navsection templete" style="background-color: #339E0B;" >
		<?php
